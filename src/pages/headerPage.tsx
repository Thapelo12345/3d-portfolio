...
export default function Header() {
  ...
  useGSAP(()=>{
    imageTimeLineRef.current = gsap.timeline({pause: true}).from(".main-image",{
      x: 510,
      rotateY: 360,
      scale: 0.05,
      stagger: 0.4,
  ...
  return (
    <div ref={headerPageRef} id="header-page" 
    ...
    >
      <div className="h-full mx-auto px-6 md:px-12 relative z-10 transition-transform duration-300 ease-out">
        ...
        <HeaderText />
          ...
          <div
          className="main-image w-full md:w-1/2 flex justify-center mt-[10%]">
